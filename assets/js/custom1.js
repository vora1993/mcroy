...
var Loan = {
    'apply' : function(button) {
        ...
        if(loan_amount > 0 && loan_tenure > 0) {
            ...
            $.ajax({
                url: full_url + '/alternative-funding/factoring-apply',
                type: 'post',
                data: data,
                dataType: 'json',
    ...
    'compare' : function(button) {
        ...
        if(loan_amount > 0 && loan_tenure > 0) {
            var data = 'id='+id+'&loan_amount='+loan_amount+'&loan_tenure='+loan_tenure;
            $.ajax({
                url: full_url + '/alternative-funding/factoring-compare',
                type: 'post',
                data: data,
                dataType: 'json',
                beforeSend: function(xhr, settings) {
    ...
    'load_compare': function() {
        $.ajax({
            url: full_url + '/alternative-funding/factoring-load-compare',
            type: 'post',
            dataType: 'json',
            success: function(json) {
    ...
    'clear_compare': function(button) {
        ...
        $.ajax({
            url: full_url + '/alternative-funding/factoring-clear-compare',
            type: 'post',
            data: 'id='+id,
            dataType: 'json',
            beforeSend: function(xhr, settings) {
